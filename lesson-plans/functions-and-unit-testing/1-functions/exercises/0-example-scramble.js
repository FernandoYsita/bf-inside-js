...
const _4_expected = 'xzy';  // Corrected expected value
const _4_actual = scramble('z', 'x', 'y');  // Corrected argument order
console.assert(_4_actual === _4_expected, 'Test 4');


const _4_expected = 'xzy'; // Corrected expected value
const _4_actual = scramble('x', 'z', 'y'); // Corrected argument order
console.assert(_4_actual === _4_expected, 'Test 4');
